...
def main(chemin):
    ...
    for _ in range (0,100):
        #affichage(infosRobots)
        infosRobots = movement(infosRobots)
    nbRobotsPerQuarter = splitIntoQuarters(infosRobots)
    safetyFactor = nbRobotsPerQuarter[0] * nbRobotsPerQuarter[1] * nbRobotsPerQuarter[2] * nbRobotsPerQuarter[3]
    return safetyFactor
